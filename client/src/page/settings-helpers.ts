...
export const AI_MODEL_PRESETS: Record<string, string[]> = {
  "worker-ai": ["llama-3-8b", "llama-3-1-8b", "llama-3-2-3b", "llama-3-3-70b", "llama-4-scout", "qwen3-30b", "gpt-oss-20b", "llama-2-7b", "mistral-7b", "mistral-7b-v2", "gemma-2b", "gemma-7b", "deepseek-coder", "qwen-7b"],
